...
var translate = new translate_1.v2.Translate();
var TranslateManager = /** @class */ (function () {
     ...
     */
    TranslateManager.translateFromUrl = function (url) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var res, parsed, htmlNode, bodyNode, translated, final;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, translate.translate([bodyNode.outerHTML], {
                                format: 'html',
                                to: 'zh'
                            })];
                    case 2:
                        translated = _b.sent();
                        final = (_a = translated[0]) === null || _a === void 0 ? void 0 : _a[0];
                        if (final == null)
